...
Simple enough? Keep printing "Still running..." for 1 second and then stop. Guess what? It's a never-ending loop. Try it yourself in the console or check the [jsfiddle](http://jsfiddle.net/raL53b7s/4/) (**Warning: It may hang or crash your browser.**)
